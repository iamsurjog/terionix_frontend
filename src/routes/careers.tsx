...
export const Route = createFileRoute('/careers')({ loader: async () => readContent(), component: Careers })
...
function Careers() {
  ...
  return (
    <div className="font-sans text-text">
      <Navbar active="Careers in Terionix" links={content.navbar.links} logo={content.site.logo} siteName={content.site.name} />
