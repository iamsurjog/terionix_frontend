...
function AboutRecycling() {
  ...
  return (
    <div className="font-sans text-text">
      <Navbar active="/about-recycling" links={content.navbar.links} cta={content.navbar.cta} logo={content.site.logo} siteName={content.site.name} socialLinks={content.social?.links || []} />
