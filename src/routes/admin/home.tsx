...
function AdminHome() {
  ...
  const [json, setJson] = useState(JSON.stringify(data.home, null, 2))
    ...
    <div className="font-sans text-text">
      ...
      <main className="pt-32 pb-24 px-4">
        <div className="max-w-3xl mx-auto">
          <h1 className="font-title text-3xl font-bold mb-2">Home</h1>
          ...
          <button onClick={async () => {
            try { await updateSection({ data: { section: 'home', content: JSON.parse(json) } }); setMsg('Saved!') }
