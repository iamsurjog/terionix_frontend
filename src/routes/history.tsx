                ...
                <div className="max-w-4xl mx-auto relative">
                    ...
                    <div className="space-y-6 text-text/70 leading-relaxed text-lg">
                        <p className="relative pl-6 border-l-4 border-secondary">
                            <span className="text-accent font-semibold">Lorem ipsum</span> dolor sit amet, consectetur
                        ...
                        <p>
                            <span className="text-secondary font-semibold">Nemo enim ipsam</span> voluptatem quia
